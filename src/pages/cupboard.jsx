 ...
 * Загружает список товаров из Zustand store, отображает их и позволяет добавлять в корзину.
 *
 * Этот компонент использует Zustand для управления состоянием и контекст для работы с корзиной.
 *
 * @component
