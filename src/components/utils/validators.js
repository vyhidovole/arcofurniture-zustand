 ...
 * @property { function(string): string|null} email - Валидатор электронной почты.
...
/**
 * Функция для валидации формы на основе предоставленнх валидаторов.
 * @param {Object} formData -Данные формы предоставленные в виде объекта.
